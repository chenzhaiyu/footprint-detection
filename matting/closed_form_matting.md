...
|------------------|-----------------|--------------|-------------------|
| ![Original image](https://github.com/MarcoForte/closed-form-matting/blob/master/testdata/source.png) | ![Scribbled image](https://github.com/MarcoForte/closed-form-matting/blob/master/testdata/scribbles.png) | ![Output alpha](https://github.com/MarcoForte/closed-form-matting/blob/master/testdata/output_alpha.png) | ![Output foreground](https://github.com/MarcoForte/closed-form-matting/blob/master/testdata/output_foreground.png) |
