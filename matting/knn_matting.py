...
if __name__ == '__main__':
    ...
    img = cv2.imread('images/knn_matting/donkey.png')
    trimap = cv2.imread('images/knn_matting/donkeyTrimap.png')
    alpha = knn_matte(img, trimap)
    cv2.imwrite("images/knn_matting/donkeyAlpha.png", alpha * 255)
    cv2.imshow("Result", alpha * 255)
    cv2.waitKey(0)
